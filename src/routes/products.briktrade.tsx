  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BrikTrade — Buy, Sell & Collect LEGO®" },
      {
        ...
        content: "The first all-in-one platform for LEGO® collectors and builders.",
      },
    ],
  }),
      ...
      <main className="bt-root flex-1">
        ...
        <div className="bt-hero">
          <div className="bt-hero-inner">
            ...
            <p className="bt-lead">
              The first all-in-one marketplace for LEGO® collectors and builders. Buy, sell, and
              manage your sets and parts with AI-powered pricing — all in one place.
            </p>
            <SignupForm ctaLabel="Notify Me at Launch" />
            <div style={{ marginTop: 20 }}>
              <a href="#features" className="bt-btn-secondary">
                See Features
              </a>
            </div>
          </div>
        ...
        <div className="bt-usp-strip">
          <div className="bt-usp-inner">
            <div className="bt-usp-text">
              <h2>
                LEGO® reselling was scattered.
                <br />
                We fixed it.
              </h2>
              <p>
                Collectors and resellers have always had to juggle spreadsheets, multiple apps, and
                outdated price guides just to figure out what their sets are worth — let alone find
                buyers or manage their inventory.
              </p>
              <p>
                BrikTrade brings everything under one roof. The smart, modern platform that LEGO®
                fans have been waiting for.
              </p>
            </div>
            <div className="bt-usp-highlight">
              <p>
                "The first platform built specifically for LEGO® collectors — marketplace,
                collection manager, and community all in one."
              </p>
              <p className="bt-sub">
                No more spreadsheets. No more switching apps. Whether you flip sets, hunt minifigs,
                or just love to build — BrikTrade has you covered.
              </p>
            </div>
          </div>
        </div>
        ...
        <div id="features">
          <div className="bt-section-wrap">
            ...
            <p className="bt-section-sub">
              From casual collectors to serious resellers, BrikTrade has the tools to take your
            ...
            <div className="bt-features-grid">
              <div className="bt-feature-card bt-fc-green">
                ...
                <p>
                  Catalog your entire LEGO® collection — sets, parts, and minifigs. Track condition,
                  completeness, and real-time value all in one place.
                </p>
              </div>
              <div className="bt-feature-card bt-fc-yellow">
                ...
                <p>
                  Buy and sell sets and parts directly within the app. The first true LEGO®
                  marketplace built into the platform — no redirects, no friction.
                </p>
              </div>
              <div className="bt-feature-card bt-fc-blue">
                ...
                <p>
                  Stop guessing what your sets are worth. Our AI analyzes real sales data to give
                  you accurate, up-to-date pricing on sets, parts, and minifigs.
                </p>
              </div>
              <div className="bt-feature-card bt-fc-red">
                ...
                <p>
                  Watch your collection's value in real time. Know which sets are appreciating, what
                  to sell now, and what to hold for maximum return.
                </p>
              </div>
              <div className="bt-feature-card bt-fc-purple">
                ...
                <p>
                  Connect with LEGO® fans worldwide. Share your hauls, discuss investment strategy,
                  trade deals, and find rare parts from fellow enthusiasts.
                </p>
              </div>
              <div className="bt-feature-card bt-fc-orange">
                ...
                <p>
                  Find any set, theme, or individual part with powerful search and filtering. Browse
                  listings or add to your want list for instant alerts.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bt-ai-section" style={{ paddingTop: 80 }}>
          <div className="bt-ai-callout">
            ...
            <p>
              LEGO® set values shift constantly with retirements, trends, and seasonal demand. Our
              AI pricing engine tracks real market sales so every listing and purchase is grounded
              in live data — giving buyers confidence and sellers the edge they need.
            </p>
          </div>
        </div>
        ...
        <div className="bt-section-wrap">
          ...
          <p className="bt-section-sub">
            BrikTrade is launching soon across web, iOS, and Android. Be the first to know.
          </p>
          ...
          <div className="bt-age-notice">
            ...
            <p>
              ...
              Browsing and managing your collection is available to everyone. Participation in the
              marketplace and community boards is restricted to users
        ...
        <div className="bt-cta-section">
          ...
          <p>
            Be among the first LEGO® collectors on BrikTrade and start turning bricks into value.
          </p>
          <SignupForm ctaLabel="Get Early Access" large />
          <p className="bt-cta-from">
